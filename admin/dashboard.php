  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'kelas') { echo 'class="active"'; } ?>>
                <a href="?page=kelas"><i class="fa fa-university"></i> <span>Manajemen Angkatan</span></a>
            </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; Teknik Informatika <a href="http://almsaeedstudio.com"></a>.</strong> All rights reserved. Powered by : <a href="">Teknik Informatika</a>
      </footer>
